...
export default defineConfig({
  ...
  sitemap: {
    hostname: "https://izaiaspertrelly.github.io/openfoundry",
  ...
  themeConfig: {
    ...
    editLink: {
      pattern: "https://github.com/Izaiaspertrelly/openfoundry/tree/main/docs/:path",
    ...
    socialLinks: [
      { icon: "github", link: "https://github.com/Izaiaspertrelly/openfoundry" },
    ],

    footer: {
      message: "Released under the GNU AGPL-3.0-only License.",
      copyright: "Original copyright © 2026 DioCrafts; modifications © 2026 Izaias Pertrelly",
    },
  },
});
