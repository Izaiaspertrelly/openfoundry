...
| `ci-frontend.yml` | React/Vite lint, TypeScript checks, unit tests, E2E, and production build. | `pnpm --filter @izaiaspertrelly/web lint`, `pnpm --filter @izaiaspertrelly/web check`, `pnpm --filter @izaiaspertrelly/web test:unit`, `pnpm --filter @izaiaspertrelly/web build` |
