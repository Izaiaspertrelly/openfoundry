<div align="center">
  <a href="https://github.com/Izaiaspertrelly/openfoundry">
  ...
  **The Open-Source Data Operating System**
  ...
  [![Go CI](https://github.com/Izaiaspertrelly/openfoundry/actions/workflows/openfoundry-go.yml/badge.svg)](https://github.com/Izaiaspertrelly/openfoundry/actions/workflows/openfoundry-go.yml)
  [![Frontend CI](https://github.com/Izaiaspertrelly/openfoundry/actions/workflows/ci-frontend.yml/badge.svg)](https://github.com/Izaiaspertrelly/openfoundry/actions/workflows/ci-frontend.yml)
  [![Proto Check](https://github.com/Izaiaspertrelly/openfoundry/actions/workflows/proto-check.yml/badge.svg)](https://github.com/Izaiaspertrelly/openfoundry/actions/workflows/proto-check.yml)
  [![License: AGPL-3.0-only](https://img.shields.io/badge/License-AGPL--3.0--only-blue.svg)](LICENSE)

  [Documentation](docs/) · [Architecture](ARCHITECTURE.md) · [Contributing](CONTRIBUTING.md) · [Security](SECURITY.md) · [Issues](https://github.com/Izaiaspertrelly/openfoundry/issues)
</div>
...
```sh
git clone https://github.com/Izaiaspertrelly/openfoundry.git
cd openfoundry-go
```
...
```sh
pnpm install
pnpm --filter @izaiaspertrelly/web dev
```
...
```sh
pnpm --filter @izaiaspertrelly/web dev
pnpm --filter @izaiaspertrelly/web check
pnpm --filter @izaiaspertrelly/web test
```
...
- Open a bug report or feature request in [GitHub Issues](https://github.com/Izaiaspertrelly/openfoundry/issues).
