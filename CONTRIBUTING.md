...
2.1). Report conduct issues privately through the repository owner's GitHub profile.
...
- **Documentation**: <https://izaiaspertrelly.github.io/openfoundry/>
- **Discussions / Q&A**: GitHub Discussions on this repository.
- **Maintainer ping**: mention `@Izaiaspertrelly` on your
  issue or PR.
