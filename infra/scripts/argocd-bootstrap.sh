...
#                                 Default: https://github.com/Izaiaspertrelly/openfoundry.git
...
OPENFOUNDRY_GITOPS_REPO="${OPENFOUNDRY_GITOPS_REPO:-https://github.com/Izaiaspertrelly/openfoundry.git}"
