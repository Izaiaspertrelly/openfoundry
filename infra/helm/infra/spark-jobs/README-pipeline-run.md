...
| `${pipeline_runner_image}`   | string  | `ghcr.io/izaiaspertrelly/pipeline-runner:0.1.0` | Built in **Tarea 3.3**. Until 3.3 lands the Pod will fail to pull.                      |
...
export pipeline_runner_image=ghcr.io/izaiaspertrelly/pipeline-runner:0.1.0
