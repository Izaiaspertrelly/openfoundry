/**
 * `@izaiaspertrelly/sdk/media` — Media reference helpers for OSDK
 * applications.
 *
 ...
 *   getDownloadUrl,
 *   type MediaReference,
 * } from '@izaiaspertrelly/sdk/media';
 *
 ...
 *  `Client` type from `@izaiaspertrelly/sdk`; we accept anything with a
