...
Single Go module (`github.com/Izaiaspertrelly/openfoundry`) plus a React
...
pnpm --filter @izaiaspertrelly/web check  # tsc -b --noEmit
pnpm --filter @izaiaspertrelly/web test   # vitest
```
