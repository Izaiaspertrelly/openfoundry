    ...
    $$
    {
      ...
      "settings": {
        ...
        "slate": {
          "enabled": false,
          "framework": "react",
          "package_name": "@izaiaspertrelly/customer-portal",
          "entry_file": "src/App.tsx",
          "sdk_import": "@izaiaspertrelly/sdk/react"
        }
      }
    }
    $$::jsonb
    ...
    $$
    {
          ...
          "widgets": [
            {
              ...
              "description": "",
              "position": { "x": 0, "y": 0, "width": 12, "height": 2 },
              "props": { "content": "# Slate Starter\nGenerate a React package with `@izaiaspertrelly/sdk/react`, then keep iterating in your own repo." },
              "events": [],
              "children": []
            },
            {
              ...
              "binding": {
                "source_type": "query",
                "query_text": "select 'sdk' as key, '@izaiaspertrelly/sdk/react' as value union all select 'framework', 'React' union all select 'entry', 'src/App.tsx'"
              },
              "events": [],
              "children": []
            }
      ...
      "settings": {
        ...
        "slate": {
          "enabled": true,
          "framework": "react",
          "package_name": "@izaiaspertrelly/slate-starter",
          "entry_file": "src/App.tsx",
          "sdk_import": "@izaiaspertrelly/sdk/react"
        }
      }
