// Package server hosts the substrate HTTP surface for llm-catalog-service.
// /healthz only — no /api/v1/* yet (matches Rust which is `fn main(){}`).
package server
...
import (
	...
	"github.com/Izaiaspertrelly/openfoundry/services/llm-catalog-service/internal/config"
)
