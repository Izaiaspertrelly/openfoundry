// Package ldap is the placeholder Go side of
// `services/connector-management-service/src/connectors/ldap.rs`.
//
...
//
// When Rust grows a real LDAP connector, the file-by-file port lands here
...
// binds this adapter under, matching Rust's `connectors::ldap` module name.
const ConnectorType = "ldap"

// Adapter is the skeleton [adapters.ConnectorAdapter] for LDAP. It holds
...
// `connectors::ldap` module is an empty placeholder.
