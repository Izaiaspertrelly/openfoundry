...
import (
	...
	"github.com/Izaiaspertrelly/openfoundry/services/dataset-versioning-service/internal/config"
	"github.com/Izaiaspertrelly/openfoundry/services/dataset-versioning-service/internal/handlers"
	"github.com/Izaiaspertrelly/openfoundry/services/dataset-versioning-service/internal/repo"
	retentionworker "github.com/Izaiaspertrelly/openfoundry/services/dataset-versioning-service/internal/runtime/retention"
	"github.com/Izaiaspertrelly/openfoundry/services/dataset-versioning-service/internal/server"
)
...
func main() {
	...
	srv := server.New(cfg, jwt, h, metrics, probes.Postgres("datasets", pool))
