...
import (
	...
	"github.com/Izaiaspertrelly/openfoundry/services/identity-federation-service/internal/config"
	"github.com/Izaiaspertrelly/openfoundry/services/identity-federation-service/internal/handlers"
	"github.com/Izaiaspertrelly/openfoundry/services/identity-federation-service/internal/repo"
	"github.com/Izaiaspertrelly/openfoundry/services/identity-federation-service/internal/server"
	"github.com/Izaiaspertrelly/openfoundry/services/identity-federation-service/internal/service"
	oidcpkg "github.com/Izaiaspertrelly/openfoundry/services/identity-federation-service/internal/oidc"
	webauthnpkg "github.com/Izaiaspertrelly/openfoundry/services/identity-federation-service/internal/webauthn"
)
...
func main() {
	...
	srv := server.New(cfg, jwt, auth, mfa, wa, sso, rbac, metrics, probes.Postgres("primary", pool))
